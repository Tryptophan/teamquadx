...
<body>
	...
	<div class="footer">
		<div class="footer-links-sm-md-lg footer-links hidden-xs">
			...
			<a href="http://github.com/Tryptophan/FTC6299" target="_blank"><div class="facebook-icon"></div></a>
			<a href="http://youtube.com/" target="_blank"><div class="youtube-icon"></div></a>
